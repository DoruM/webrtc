...
var conn;
var session;
var jmsServerURL = 'wss://kaazing.example.com:8000/';
...
function handleVideo (myStream) { 
        ...
        console.log("debug : 1");
         ...
         var configuration = { 
            ...
            "iceServers": [{ 
                "url": "turn:kaazing.example.com:3478?transport=tcp",
                "username": "kaztest",
                "credential": "kazpass",
        ...
        console.log("debug : 2");
         ...
         yourConn.onicecandidate = function (event) { 
            ...
            if (event.candidate) { 
// TODO have this by default
    if(event.candidate.candidate.indexOf("relay")<0){ 
        console.log("dpw: " + " with RTC peer address:" + event.candidate.candidate);
        return;
    }else{
        console.log("FOUND RELAY CANDIDATE !!!!! ------------------");
    }
               send({ 
                  type: "candidate", 
